...
def intro():
    ...
    print('\n'*5)                                                                                     
    print(' Welcome to Black Jack! You think you can beat the dealer???')
    print('\n'*3)
...
while True: 
    ...
    # set up the deck for the game and shuffle it
    deck = Deck()
    deck.shuffle()

    # Generate two hands and deal two cards to each person
    player_hand = Hand()
    ...
    # Show some cards but keep a few hidden
